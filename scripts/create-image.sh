...
az sig image-version create --resource-group $rg_name --gallery-name $image_gallery_name --gallery-image-definition $image_defintion --gallery-image-version 3.0.0 --managed-image "/subscriptions/$subscriptionID/resourceGroups/$rg_name/providers/Microsoft.Compute/virtualMachines/$vm_name"
